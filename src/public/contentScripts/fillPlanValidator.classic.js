...
const FILL_PLAN_VERSION = "0.1";

const FILL_PLAN_CONTROL_KINDS = /** @type {const} */ ([
  "input",
  "textarea",
  "select",
  "radio-group",
...
const FILL_PLAN_VALUE_SOURCES = /** @type {const} */ ([
  "profile",
  "resume_details",
  "derived",
  "literal",
...
const FILL_PLAN_APPLY_MODES = /** @type {const} */ ([
  "set_value",
  "select_best_option",
  "click_best_label",
  "upload_resume",
...
const FILL_PLAN_SENSITIVE_CATEGORIES = /** @type {const} */ ([
  "eeo",
  "health",
  "biometric",
  "none",
...
const FILL_PLAN_TRANSFORM_OPS = /** @type {const} */ ([
  "trim",
  "collapse_whitespace",
  "ensure_https",
  "full_name_part",
 ...
 * @returns {{ok: true, value: any, errors: []} | {ok: false, value: any, errors: FillPlanValidationError[]}}
 */
function parseAndValidateFillPlanJSON(json) {
  let value;
  try {
 ...
 * @returns {any}
 */
function assertValidFillPlan(plan) {
...
try {
  if (typeof window !== "undefined") {
    window.__exempliphaiFillPlan = {
      ...
      validateFillPlan,
      // Back-compat alias (older callers expected .validate)
