          ...
          >
            {marqueeItems.map((t, index) => (
              <div
                ...
                className="max-w-xs flex flex-col flex-none rounded-xl border border-muted bg-gradient-to-bl from-blue-600/20 to-background p-6 md:max-w-md md:p-10 dark:to-black"
              >
